...
public class AddResumoDocs {
 ...
 private String prateleira;
    ...
    public AddResumoDocs(String id_doc, String titulo_doc, String ref_origem, String ref_loca, String descricao, String quant, String valor, String localizacao, String fonte, String data_entrada, String status, String grupo, String formato, String edicao_data, String edicao_revisao, String armario, String prateleira) {
        this.id_doc = id_doc;
    ...
    public ArrayList<AddResumoDocs> acordotList()
    {
        ArrayList<AddResumoDocs> aList = new ArrayList<>();
        ...
        try {
            ...
            while(rs.next())
            {
                p = new AddResumoDocs(rs.getString("id_doc"),rs.getString("titulo_doc"),rs.getString("ref_origem"),
